...
CREATE TABLE CUSTOMERS (
    ...
    CONSTRAINT FK_CUSTOMERS_CREATEDBY FOREIGN KEY (CREATEDBY) REFERENCES USERS(KEY) ON DELETE SET NULL,
    CONSTRAINT FK_CUSTOMERS_MODIFIEDBY FOREIGN KEY (MODIFIEDBY) REFERENCES USERS(KEY) ON DELETE SET NULL
);
...
CREATE TABLE CATEGORIES (
    ...
    CONSTRAINT FK_CATEGORIES_CREATEDBY FOREIGN KEY (CREATEDBY) REFERENCES USERS(KEY) ON DELETE SET NULL,
    CONSTRAINT FK_CATEGORIES_MODIFIEDBY FOREIGN KEY (MODIFIEDBY) REFERENCES USERS(KEY) ON DELETE SET NULL
);

-- Crear secuencia para la columna KEY
CREATE SEQUENCE CATEGORYKEYSEQ START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE TABLE SUPPLIERS (
    ...
    CONSTRAINT FK_SUPPLIERS_CREATEDBY FOREIGN KEY (CREATEDBY) REFERENCES USERS(KEY) ON DELETE SET NULL,
    CONSTRAINT FK_SUPPLIERS_MODIFIEDBY FOREIGN KEY (MODIFIEDBY) REFERENCES USERS(KEY) ON DELETE SET NULL
);

-- Crear secuencia para la columna KEY
CREATE SEQUENCE SUPPLIERKEYSEQ START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
